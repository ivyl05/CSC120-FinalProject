 ...
 * Description: This is a main class for the Farming Game
 * Author: Ivy Li
...
/**
 * It handles user interactions and give various options including purchasing seeds, planting and growing crops, 
 * buying animals, cooking, and achieving set goals within a time limit.
 */
class Player {

    /**
     * Main method that allows interaction with player and provide instructions for this game
     * 
     * @param args
     */
    public static void main(String[] args) {
        ...
        // Track the number of food items made.
        ...
        //Check whether the player wishes to play the game
        while (true) {
            ...
            if (choice.equals("yes")) {
                ...
                System.out.println("2. Make " + applePieGoal + " applepies.");
        ...
        while (running) {
            ...
            // Depend on which choice the player choose and switch to that case. Learned how to implement try switch using ChatGPT
            try {
                ...
                case 5:
                    System.out.println("What would you like to cook? (sandwich, applepie, pizza, cheese, cream)");
                ...
                case 9:
                    ...
                    try {
                        CropType cropType = CropType.valueOf(undoseedType.toLowerCase());
                        myPlant.unbuySeeds(cropType, undoseedCount);
                    } catch (IllegalArgumentException e) {
                        System.out.println("Opps! Invalid crop type. Please try again.");
                    }
                    break;
                ...
                case 10:
                    ...
                    try {
                        CropType crop = CropType.valueOf(cropType.toLowerCase());
                ...
                case 11:
                    ...
                    try {
                        AnimalType animal = AnimalType.valueOf(undoanimalType.toLowerCase());
                        myAnimals.unbuyAnimal(animal, undoanimalCount);
                    } catch (IllegalArgumentException e) {
                        System.out.println("Opps! Invalid animal type. Please try again.");
                    }
                    break;
